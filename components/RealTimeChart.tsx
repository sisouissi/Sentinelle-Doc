  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <AreaChart data={data} margin={{ top: 5, right: 20, left: -15, bottom: 5 }}>
        ...
        <Area yAxisId="left" type="monotone" dataKey={stepsKey} name={stepsKey} stroke="#3b82f6" fillOpacity={1} fill="url(#colorSteps)" strokeWidth={2} />
        <Area yAxisId="right" type="monotone" dataKey={activeMinutesKey} name={activeMinutesKey} stroke="#14b8a6" fillOpacity={1} fill="url(#colorActive)" strokeWidth={2} />
      </AreaChart>
    </ResponsiveContainer>
  );
}